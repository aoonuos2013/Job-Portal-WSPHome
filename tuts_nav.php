...
.nav-side-menu li {
  padding-left: 0px;
  border-left: 3px solid rgb(66, 95, 202);
  border-bottom: 1px solid #23282e;
}
.nav-side-menu li a {
...
<aside>
 ...
 <?php $res1=mysql_query("SELECT * from parent_cat"); ?>
 
<div class="nav-side-menu">
    <div class="brand">Others Tutorials</div>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
               <?php
                ...
                <li data-toggle="collapse" data-target="#service" class="collapsed" style="margin-left:20px;">
                  <a href="tuts_detail.php?cat=<?php echo $row['cat_id']; ?>"> <?php echo $row['cat_name']; ?> <span class="arrow"></span></a>
                </li>  
